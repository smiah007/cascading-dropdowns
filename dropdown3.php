...
<head>
	...
	<h1 itemprop=\"headline\">Cascading Dropdown > State > City JQuery</h1>";

	//Cascading Dropdown Menu
	require "dropdown3-link.php";

	echo "<table><tr><form method=post id=f1 action=dropdown3-ck.php><td>";
	...
	echo "</select></td> 
	<td><select class='form-control' id=state_id name=state_id><option value=''>Select State</option></select></td>
...
$(document).ready(function() {
	...
	$("#country_code").change(function(){ // change function of listbox
		...
		$.post( "dropdown3ck.php", {
				"country_code":$('#country_code').val()},function(return_data,status){
